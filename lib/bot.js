...
const token = "5578227663:AAGodFdAgzCiavrFwOhTV-U6lYk87BqoUss";
...
bot.on("message", (msg) => {
    ...
    if(!isNaN(numberToApplyFb)){
        const fizzbuzzTrick = ExplorerController.fizzbuzzNumber(numberToApplyFb);
...
bot.on("messages", (msg) => {
    ...
    if(Mission === "node") {
        ...
        byMission.map((explorers) => {
            bot.sendMessage(chatId, explorers.username);
